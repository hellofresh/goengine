...
func (_m *PersistenceStrategy) GenerateTableName(streamName goengine.StreamName) (string, error) {
	ret := _m.Called(streamName)

	var r0 string
	if rf, ok := ret.Get(0).(func(goengine.StreamName) string); ok {
		r0 = rf(streamName)
	} else {
		r0 = ret.Get(0).(string)
	}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(goengine.StreamName) error); ok {
		r1 = rf(streamName)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *PersistenceStrategy) PrepareData(_a0 []goengine.Message) ([]interface{}, error) {
	ret := _m.Called(_a0)

	var r0 []interface{}
	if rf, ok := ret.Get(0).(func([]goengine.Message) []interface{}); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func([]goengine.Message) error); ok {
		r1 = rf(_a0)
	} else {
		r1 = ret.Error(1)
	}
