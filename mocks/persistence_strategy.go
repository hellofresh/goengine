...
func (_m *PersistenceStrategy) PrepareData(_a0 []messaging.Message) ([]interface{}, error) {
	ret := _m.Called(_a0)

	var r0 []interface{}
	if rf, ok := ret.Get(0).(func([]messaging.Message) []interface{}); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func([]messaging.Message) error); ok {
		r1 = rf(_a0)
	} else {
		r1 = ret.Error(1)
	}
